        ...
        <div className=" mx-4 mt-4">
            ...
            <form className="flex items-center mt-4">
                ...
                <div className="relative w-full">
                    ...
                    <input type="text" id="simple-search" className="bg-slate-50  text-slate-900 text-sm rounded-lg  block w-full pl-10 p-2.5   dark:placeholder-slate-400 dark:text-white " placeholder="Search" required />
                </div>
